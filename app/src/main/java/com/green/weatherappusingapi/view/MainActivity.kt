/***************************************************************************************
 *    Title: <Fetch data from API in Android Studio (Kotlin) using Retrofit with MVVM Architecture.>
 *    Author: <Dimas Wisodewo>
 *    Date Published: <14 January 2023>
 *    Date Retrieved: <16 August 2023>
 *    Code version: <1.0.0>
 *    Availability: <https://medium.com/@dimaswisodewo98/fetch-data-from-api-in-android-studio-kotlin-using-retrofit-with-mvvm-architecture-4f6b673f6a28>
 *
 ***************************************************************************************/

package com.green.weatherappusingapi.view
...
import com.green.weatherappusingapi.R
import com.green.weatherappusingapi.model.CurrentWeatherResponse
import com.green.weatherappusingapi.viewmodel.MainViewModel
